...
export type InsertCurrencyPair = typeof currencyPairs.$inferInsert;
...
export type InsertSpreadSetting = typeof spreadSettings.$inferInsert;
...
export type InsertAutoApprovalSetting = typeof autoApprovalSettings.$inferInsert;

export type SwapPoint = typeof swapPoints.$inferSelect;
export type InsertSwapPoint = typeof swapPoints.$inferInsert;

export type SwapPointsHistory = typeof swapPointsHistory.$inferSelect;
export type InsertSwapPointsHistory = typeof swapPointsHistory.$inferInsert;

export type OnTnRate = typeof onTnRates.$inferSelect;
export type InsertOnTnRate = typeof onTnRates.$inferInsert;
